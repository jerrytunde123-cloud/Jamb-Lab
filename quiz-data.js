...
const quizData = {
    english: {
        ...
        questions: [
            ...
            {
                question: "Choose the option that is nearest in meaning to the idiom: The manager decided to let the cat out of the bag.",
                options: ["Release a cat", "Reveal a secret", "Cause trouble", "Create confusion"],
                correct: 1
            },
            {
                question: "Choose the option with the correct stress pattern:",
            ...
            {
                question: "Choose the option that is nearest in meaning: The politician's speech was full of hyperbole.",
                options: ["Truth", "Exaggeration", "Wisdom", "Sincerity"],
                correct: 1
            },
            {
                question: "Choose the option that best completes the sentence: The meeting was adjourned ______ further notice.",
                options: ["for", "until", "till", "by"],
                correct: 1
            },
            {
            ...
            {
                question: "Choose the option that best completes the sentence: Scarcely had we started eating ______ the lights went out.",
                options: ["than", "when", "that", "then"],
                correct: 1
            },
            {
                question: "Choose the option that is opposite in meaning: The witness gave a coherent account of the incident.",
                options: ["Clear", "Confused", "Detailed", "Honest"],
                correct: 1
            },
            {
    ...
    mathematics: {
        ...
        questions: [
            ...
            {
                question: "In a class of 50 students, 30 play football, 25 play basketball, and 10 play both. How many play neither?",
                options: ["5", "10", "15", "20"],
                correct: 0
            },
            {
            ...
            },
            {
                ...
                options: ["y = -½x + 3", "y = ½x - 1", "y = -2x + 9", "y = 2x - 7"],
                correct: 0
            },
            {
            ...
            {
                question: "If tan θ = 3/4 and θ is acute, find sin θ + cos θ.",
                options: ["7/5", "5/7", "1", "12/25"],
                correct: 0
            },
            {
                question: "The angle of elevation of the top of a building from a point 40m away is 45°. Find the height of the building.",
                options: ["40m", "20m", "80m", "40√2 m"],
                correct: 0
            },
            {
    ...
    physics: {
        ...
        questions: [
            ...
            },
            {
                ...
                options: ["30 cm", "20 cm", "15 cm", "25 cm"],
                correct: 0
            },
            {
            ...
            {
                question: "The threshold wavelength of a metal is 500nm. Find the work function. (h = 6.6 × 10⁻³⁴ Js, c = 3 × 10⁸ m/s)",
                options: ["3.96 × 10⁻¹⁹ J", "1.98 × 10⁻¹⁹ J", "5.94 × 10⁻¹⁹ J", "7.92 × 10⁻¹⁹ J"],
                correct: 0
            },
            {
                question: "A body executes SHM with amplitude 5cm and period 2s. Find the maximum velocity.",
                options: ["5π cm/s", "10π cm/s", "2.5π cm/s", "20π cm/s"],
                correct: 0
            },
            {
            ...
            {
                question: "Calculate the pressure at a depth of 10m in water. (ρ = 1000 kg/m³, g = 10 m/s²)",
                options: ["100,000 Pa", "10,000 Pa", "1,000 Pa", "1,000,000 Pa"],
                correct: 0
            },
            {
                question: "A convex lens of focal length 20cm forms a real image at 60cm. Find the object distance.",
                options: ["30 cm", "40 cm", "20 cm", "15 cm"],
                correct: 0
            },
            {
    ...
    chemistry: {
        ...
        questions: [
            ...
            {
                question: "The rate of a reaction doubles when temperature increases by 10°C. If the rate is 2 mol/dm³/s at 20°C, what is it at 50°C?",
                options: ["16 mol/dm³/s", "8 mol/dm³/s", "32 mol/dm³/s", "4 mol/dm³/s"],
                correct: 0
            },
            {
            ...
            },
            {
                ...
                options: ["NaCl", "CH₄", "H₂O", "C₂H₅OH"],
                correct: 0
            },
            {
                question: "Calculate the volume of CO₂ produced at STP when 10g of CaCO₃ is heated. (Ca = 40, C = 12, O = 16)",
                options: ["2.24 dm³", "22.4 dm³", "1.12 dm³", "4.48 dm³"],
                correct: 0
            },
            {
            ...
            {
                question: "Calculate the molar mass of Na₂CO₃·10H₂O. (Na = 23, C = 12, O = 16, H = 1)",
                options: ["286 g/mol", "106 g/mol", "180 g/mol", "240 g/mol"],
                correct: 0
            },
            {
    ...
    biology: {
        ...
        questions: [
            ...
            {
                question: "Which of the following is the correct pathway of blood in the human body?",
                options: ["Right atrium → Right ventricle → Lungs", "Left atrium → Left ventricle → Lungs", "Right atrium → Left ventricle → Body", "Left atrium → Right ventricle → Lungs"],
                correct: 0
            },
            {
            ...
            {
                question: "In a population of 1000 individuals, 360 have the recessive phenotype. What is the frequency of the recessive allele?",
                options: ["0.6", "0.4", "0.36", "0.64"],
                correct: 0
            },
            {
            ...
            {
                question: "A woman who is a carrier of haemophilia marries a normal man. What is the probability that their son will be haemophilic?",
                options: ["50%", "25%", "0%", "100%"],
                correct: 0
            },
            {
            ...
            {
                question: "The process by which plants lose water vapour through the stomata is:",
                options: ["Transpiration", "Respiration", "Photosynthesis", "Guttation"],
                correct: 0
            },
            {
                question: "Which of the following is a function of the kidney?",
                options: ["Regulation of blood pressure", "Production of bile", "Storage of glycogen", "Production of insulin"],
                correct: 0
            }
        ]
    },
    ...
    government: {
        ...
        questions: [
            ...
            {
                question: "The principle that all citizens are equal before the law is known as:",
                options: ["Equality before the law", "Fundamental human rights", "Rule of law", "Due process"],
                correct: 0
            },
            {
            ...
            },
            {
                ...
                options: ["Both head of state and head of government", "Only head of state", "Only head of government", "Ceremonial head"],
                correct: 0
            },
            {
    ...
    literature: {
        ...
        questions: [
            ...
            {
                question: "The theme of 'The Old Man and the Sea' is:",
                options: ["Perseverance against nature", "Love and romance", "Political struggle", "Family conflict"],
                correct: 0
            },
            {
            ...
            {
                question: "In 'Things Fall Apart', the missionaries are significant because:",
                options: ["They introduced Christianity which divided the community", "They brought education only", "They fought against the British", "They supported Okonkwo"],
                correct: 0
            },
            {
            ...
            {
                question: "In 'The Lion and the Jewel', the conflict is between:",
                options: ["Tradition and modernity", "Rich and poor", "Young and old only", "Men and women only"],
                correct: 0
            },
            {
            ...
            {
                question: "The main character in 'The Old Man and the Sea' is:",
                options: ["Santiago", "Manolin", "The marlin", "The sharks"],
                correct: 0
            },
            {
            ...
            {
                question: "In 'Things Fall Apart', the locusts symbolize:",
                options: ["The coming of the white man", "Good harvest", "Natural disaster", "War"],
                correct: 0
            },
            {
